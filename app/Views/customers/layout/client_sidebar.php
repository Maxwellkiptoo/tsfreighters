<!-- ✅ Professional Customer Dashboard Layout -->
...
<div class="sidebar" id="sidebar">
  ...
  <a href="customer_shipments.php" class="<?php echo ($_GET['page'] ?? '') === 'shipments' ? 'active' : ''; ?>">
    <i class="fa fa-truck-fast"></i> <span>My Shipments</span>
  </a>

  <a href="customer_create_shipment.php" class="<?php echo ($_GET['page'] ?? '') === 'create' ? 'active' : ''; ?>">
    <i class="fa fa-plus-circle"></i> <span>Create Shipment</span>
  </a>

  <a href="customer_tracking.php" class="<?php echo ($_GET['page'] ?? '') === 'tracking' ? 'active' : ''; ?>">
    <i class="fa fa-map-marker-alt"></i> <span>Track Package</span>
  </a>

  <a href="customer_invoices.php" class="<?php echo ($_GET['page'] ?? '') === 'invoices' ? 'active' : ''; ?>">
    <i class="fa fa-file-invoice-dollar"></i> <span>Invoices & Payments</span>
  </a>

  <a href="customer_support.php" class="<?php echo ($_GET['page'] ?? '') === 'support' ? 'active' : ''; ?>">
    <i class="fa fa-headset"></i> <span>Customer Support</span>
  </a>

  <a href="customer_settings.php" class="<?php echo ($_GET['page'] ?? '') === 'settings' ? 'active' : ''; ?>">
...
<div class="top-header">
  <div class="header-top">
    ...
    <div class="search-box">
      ...
      <input type="text" placeholder="Search shipments or invoices...">
    </div>
  </div>
  <div class="header-bottom">
    ...
    <div class="profile-dropdown" id="profileDropdown">
      <img src="https://i.pravatar.cc/38" alt="Customer">
      <div class="dropdown-menu" id="dropdownMenu">
        <a href="customer_profile.php"><i class="fa fa-user"></i> Profile</a>
        <a href="customer_settings.php"><i class="fa fa-cogs"></i> Settings</a>
