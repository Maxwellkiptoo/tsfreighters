...
</div> <div class="carousel-inner"> <?php $slides = [ [ "img" => "../../../public/assets/images/truck4.jpg", "title" => "Delivering Beyond Borders", "text" => "Fast, Secure & Reliable Logistics Across Kenya & The Globe" ], [ "img" => "../../../public/assets/images/truck2.jpg", "title" => "Your Cargo, Our Priority", "text" => "Tailored Express Freight Solutions Backed by Innovation" ], [ "img" => "../../../public/assets/images/truck3.jpg", "title" => "Global Reach, Local Touch", "text" => "Seamless International Shipping with Trusted Local Expertise" ] ]; $imageWebPath = '../public/assets/images/'; foreach ($slides as $i => $slide): ?>
